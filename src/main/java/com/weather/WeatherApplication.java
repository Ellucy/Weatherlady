...
public class WeatherApplication {
    ...
    private static void displayMenu() {
        System.out.print(WeatherController.menu);
    }
    ...
    private static void addNewNaturalDisaster() throws IOException {
        ...
        WeatherController.addingNaturalDisaster(cityName, disaster, description);
    }
    ...
    private static void viewDisastersByDate() {
        ...
        Timestamp date = WeatherController.convertStringToTimestamp(inputDate);
        ...
        boolean isExtracted = WeatherController.getDisastersByDate(openweatherDisasters, date, accuweatherDisasters, weatherstackDisasters);
    ...
    private static void viewDisastersByName() {
        ...
        boolean isExtracted = WeatherController.getDisastersByName(openweatherDisasters,
    ...
    private static void viewDisastersByCityName() {
        ...
        boolean isExtracted = WeatherController.getDisastersByCityName(openweatherDisasters,
    ...
    private static void viewDisastersByCountryName() {
        ...
        boolean isExtracted = WeatherController.getDisastersByCountryName(openweatherDisasters,
    ...
    private static void printData(DataEntity entity) {
